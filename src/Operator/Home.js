...
function Home() {
  ...
  useEffect(() => {
    ...
    const fetchParkingLogs = async () => {
      ...
      const cumulativeRevenueData = Object.keys(hourlyRevenue)
        .sort((a, b) => +a - +b)
        .map((hour) => {
  ...
  return (
    <div className="gradient-custom-2" style={{ backgroundColor: "white" }}>
      ...
      <MDBContainer className="py-4" style={{}}>
        {" "}
        {/* Increase top margin to avoid overlap with the navbar */}
        <MDBRow>
          <MDBCol lg="4">
            <OperatorReserve />
          </MDBCol>
              ...
              <div className="col-md-3">
                <Card>
                  <Card.Body>
                    ...
                    >
                      {" "}
                      <FontAwesomeIcon icon={faCar} color="green" /> Parking
                      Availability
                    </Card.Title>
                    <Card.Text
                      style={{
